<template>
  <div>
    <div id="contents">
      <p id="notSupportedDescription">
        ※このデモはOffscreenCanvasで作成しています。<a href="https://caniuse.com/#search=OffscreenCanvas" target="_blank">OffscreenCanvasに対応したブラウザ</a>でご覧ください。
      </p>
      <canvas id="myCanvas"></canvas>
      <div id="guiContainer"></div>
      <div id="svgContainer">
        <p>ハートをクリックしてください</p>
        <svg id="btn" class="likeButton" width="150px" height="150px" viewBox="0 0 500 500">
